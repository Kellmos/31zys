...
Logger initFileLogger(String name) {
  ...
  final logFile = File('${dir.path}/${now.year}_${now.month}_${now.day}_$name.txt');
  
  logFile.writeAsStringSync('=== Log started at ${DateTime.now()} ===\n', mode: FileMode.write);
  print('Лог-файл создан: ${logFile.path}');
